...
public class Instrutor extends User implements Serializable{
	private static final long serialVersionUID = 1L;	
	
	public Instrutor() {
	}
	
	public Instrutor(String id, String nome, Date dataCadastro, Date dataNascimento, String email, String senha, 
